      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-6xl z-10 mx-auto mt-0 gap-12">
        <div ref={textRef} className="max-w-2xl w-full">
          ...
          <p className="font-body text-brand-text/90 text-lg md:text-xl max-w-2xl mb-6">
            Computer Engineer specializing in <span className="rosewhite-gradient-text font-bold">edge AI and embedded systems</span>. I take machine-learning models from Python training all the way down to FPGA silicon and the firmware that drives them. I recently earned my MEng in Computer Engineering at Dartmouth's Thayer School of Engineering, backed by a foundation of two bachelor's degrees in Electrical Engineering and Computer Science.
          </p> 
